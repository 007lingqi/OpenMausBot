...
- 完整回归首次受沙箱禁止监听 EPERM 影响，24996 主动中止 130，不计通过；相同命令获宿主权限后的 55729/7b7044 已退出 0：主集 4625 通过/18 跳过，broker、Node、打包/headless、typecheck/diff 全通过。源码已冻结，下一步固定提交及新镜像切换；新发布 kit 已完成 47 项离线合同验证，旧发布脚本不重跑。
